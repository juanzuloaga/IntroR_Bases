...
knitr::opts_knit$set(root.dir = "C:/Talleres_Ecodiversa_R/IntroR_Bases/")
```
___
...
Por favor cargue <a href="https://cran.r-project.org" target="_blank">R</a> y <a href="https://rstudio.com/products/rstudio/download/" target="_blank">RStudio</a> en su computador. Si tiene Windows usted necesitará instalar <a href="https://cran.r-project.org/bin/windows/Rtools/" target="_blank">Rtools</a>. Si usted tiene Mac, necesita instalar también Xtools del app store. 
...
![](./figures_workshop/pantalla.png){width=120% height="120%"}
...
![](./figures_workshop/help.png){width=70% height="100%"}

Lo que le ofrecerá algunos vínculos de utilidad.

![](./figures_workshop/help2.png){width=70% height="100%"}
...
![](./figures_workshop/help4.png){width=100% height="100%"}
